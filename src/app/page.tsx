    ...
    <div className="grid-pattern bg-deepBlue w-screen h-full min-h-screen">
      ...
      <section className="flex flex-col w-full items-center justify-center md:p-4">
        ...
        <div className="w-full flex flex-col items-center justify-center">
          {/* searchbox */}
          <div className="w-80 md:w-96 md:border border-grey500 flex flex-col gap-4 md:gap-2 md:bg-deepBlue md:flex-row p-1 rounded-3xl items-center justify-center">
